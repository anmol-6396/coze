...
class HomeCoBtn extends StatefulWidget {
  const HomeCoBtn({super.key});

  @override
  State<HomeCoBtn> createState() => HomeCoBtnState();
}

class HomeCoBtnState extends State<HomeCoBtn> {
  ...
  Future<void> _detectLocation() async {
    try {
      ...
      debugPrint("Location error in HomeCoaching: $e");
    }
  }
  ...
  Future<List<Map<String, dynamic>>> _fetchTutors() async {
    ...
    try {
      final subSnap = await FirebaseFirestore.instance.collectionGroup("homecoaching").get();
      ...
      debugPrint("Error fetching homecoaching ads: $e");
    }
    return docs;
  }
  ...
  Widget _buildBody(BuildContext context) {
    ...
    return Column(
      children: [
        FilterWidget(
          title: "Home Coaching Categories",
          customSections: {
